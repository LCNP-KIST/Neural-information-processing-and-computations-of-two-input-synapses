...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "ca_ion");
 	...
 	ivoc_help("help ?1 sca /Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/x86_64/sca.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 75 in file sca.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/mod_files/sca.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
