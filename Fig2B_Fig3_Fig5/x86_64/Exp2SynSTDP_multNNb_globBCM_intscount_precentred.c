...
#define nrn_init _nrn_init__Exp2SynSTDP_multNNb_globBCM_intscount_precentred
#define _nrn_initial _nrn_initial__Exp2SynSTDP_multNNb_globBCM_intscount_precentred
#define nrn_cur _nrn_cur__Exp2SynSTDP_multNNb_globBCM_intscount_precentred
#define _nrn_current _nrn_current__Exp2SynSTDP_multNNb_globBCM_intscount_precentred
#define nrn_jacob _nrn_jacob__Exp2SynSTDP_multNNb_globBCM_intscount_precentred
#define nrn_state _nrn_state__Exp2SynSTDP_multNNb_globBCM_intscount_precentred
#define _net_receive _net_receive__Exp2SynSTDP_multNNb_globBCM_intscount_precentred 
#define state state__Exp2SynSTDP_multNNb_globBCM_intscount_precentred 
...
#define B _p[12]
#define factor _p[13]
#define presyntime (_p + 14)
#define counter _p[10014]
#define total _p[10015]
#define flagOLD _p[10016]
#define DA _p[10017]
#define DB _p[10018]
#define _g _p[10019]
#define _tsav _p[10020]
#define _nd_area  *_ppvar[0]._pval
#define d	*_ppvar[2]._pval
#define _p_d	_ppvar[2]._pval
#define p	*_ppvar[3]._pval
#define _p_p	_ppvar[3]._pval
...
#define _cvode_ieq _ppvar[8]._i
 ...
 "7.7.0",
"Exp2SynSTDP_multNNb_globBCM_intscount_precentred",
 "tau1",
 "tau2",
 "e",
 "dtau",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _Exp2SynSTDP_multNNb_globBCM_intscount_precentred_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 10021, 9);
  ...
  hoc_register_dparam_semantics(_mechtype, 7, "fornetcon");
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 Exp2SynSTDP_multNNb_globBCM_intscount_precentred /Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/x86_64/Exp2SynSTDP_multNNb_globBCM_intscount_precentred.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 128 in file Exp2SynSTDP_multNNb_globBCM_intscount_precentred.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/mod_files/Exp2SynSTDP_multNNb_globBCM_intscount_precentred.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
