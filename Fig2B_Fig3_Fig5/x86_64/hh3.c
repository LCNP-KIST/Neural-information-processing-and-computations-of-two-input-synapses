...
#define evaluate_fct evaluate_fct__hh3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "evaluate_fct_hh3", _hoc_evaluate_fct,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "k_ion");
 	...
 	ivoc_help("help ?1 hh3 /Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/x86_64/hh3.mod\n");
...
static int  evaluate_fct (  double _lv ) {
   double _la , _lb , _lv2 ;
 _lv2 = _lv - vtraub ;
   _la = 0.1 * 0.32 * ( 13.0 - _lv2 ) / ( exp ( ( 13.0 - _lv2 ) / 4.0 ) - 1.0 ) ;
   _lb = 0.2 * 0.28 * ( _lv2 - 40.0 ) / ( exp ( ( _lv2 - 40.0 ) / 5.0 ) - 1.0 ) ;
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 68 in file hh3.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/mod_files/hh3.mod";
static const char* nmodl_file_text = 
