...
#define nrn_init _nrn_init__BCMthreshold3
#define _nrn_initial _nrn_initial__BCMthreshold3
#define nrn_cur _nrn_cur__BCMthreshold3
#define _nrn_current _nrn_current__BCMthreshold3
#define nrn_jacob _nrn_jacob__BCMthreshold3
#define nrn_state _nrn_state__BCMthreshold3
#define _net_receive _net_receive__BCMthreshold3 
#define state state__BCMthreshold3 
...
#define tspike _p[10]
#define scount _p[11]
#define flagOLD _p[12]
#define boltzfactor _p[13]
#define pf _p[14]
#define output _p[15]
#define Dscount _p[16]
#define v _p[17]
#define _g _p[18]
#define _tsav _p[19]
...
#define boltzman boltzman_BCMthreshold3
 double boltzman = 0;
 ...
 "boltzman_BCMthreshold3", &boltzman_BCMthreshold3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 BCMthreshold3 /Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/x86_64/BCMthreshold3.mod\n");
 ...
 v=_v;
{
 {   state(_p, _ppvar, _thread, _nt);
   ...
   alpha_scount = alpha * scount ;
   asg = pow( alpha_scount , bcm_scale ) ;
   if ( alpha_scount > 0.0 ) {
     p = p0 / asg ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/shkim/Research/neurcomp/Neural-information-processing-and-computations-of-two-input-synapses/Fig2BandFig3/mod_files/BCMthreshold3.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  ...
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS BCMthreshold3\n"
  "	RANGE d0, p0, scount0, scounttau, alpha, alpha_scount, bcm_scale, asg 		:these were GLOBAL before\n"
  ...
  "	asg = alpha_scount^bcm_scale\n"
  "	if (alpha_scount > 0) {p = p0/asg } else {p = p}\n"
  "	d = d0* asg\n"
  "    output = 0\n"
  "}\n"
  "\n"
