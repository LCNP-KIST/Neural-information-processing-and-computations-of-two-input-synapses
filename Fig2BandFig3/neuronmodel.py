...
class Neuron(object):
    ...
    def __init__(self):
        ...
        # apical
        self.apical_prox = make_compartment(self.apical_length/5.0,self.d_diam,int(self.nseg/5)+1)
        self.apical = make_compartment(4.0*self.apical_length/5.0,self.d_diam,int(4*self.nseg/5)+1)
